...
As of July 13, 2023, the federal government had committed `r SEdata$Funding[6]` in Infrastructure Investment and Jobs Act funding to Alabama, or about `r SEdata$perCapita[6]` per person. Alabama ranks 6th for funding committed within the Southeast and 3rd on a per capita basis.
<br>
```{r echo=FALSE}
...
As of July 13, 2023, the federal government had committed `r SEdata$Funding[9]` in Infrastructure Investment and Jobs Act funding to Arkansas, or about `r SEdata$perCapita[9]` per person. Arkansas ranks 9th for funding committed within the Southeast and 1st on a per capita basis.
<br>
``` {r echo=FALSE}
...
As of July 13, 2023, the federal government had committed `r SEdata$Funding[1]` in Infrastructure Investment and Jobs Act funding to Florida, or about `r SEdata$perCapita[1]` per person. Florida ranks 1st for funding committed within the Southeast and 11th on a per capita basis.
<br>
```{r echo=FALSE}
...
As of July 13, 2023, the federal government had committed `r SEdata$Funding[2]` in Infrastructure Investment and Jobs Act funding to Georgia, or about `r SEdata$perCapita[2]` per person. Georgia ranks 2nd for funding committed within the Southeast and 6th on a per capita basis.
<br>
```{r echo=FALSE}
...
As of July 13, 2023, the federal government had committed `r SEdata$Funding[7]` in Infrastructure Investment and Jobs Act funding to Kentucky, or about `r SEdata$perCapita[7]` per person. Kentucky ranks 7th for funding committed within the Southeast and 2nd on a per capita basis.
<br>
``` {r echo=FALSE}
...
As of July 13, 2023, the federal government had committed `r SEdata$Funding[8]` in Infrastructure Investment and Jobs Act funding to Louisiana, or about `r SEdata$perCapita[8]` per person. Louisiana ranks 9th for funding committed within the Southeast and 4th on a per capita basis.
<br>
``` {r echo=FALSE}
...
As of July 13, 2023, the federal government had committed `r SEdata$Funding[11]` in Infrastructure Investment and Jobs Act funding to Mississippi, or about `r SEdata$perCapita[11]` per person. Mississippi ranks 11th for funding committed within the Southeast and 5th on a per capita basis.
<br>
``` {r echo=FALSE}
...
As of July 13, 2023, the federal government had committed `r SEdata$Funding[3]` in Infrastructure Investment and Jobs Act funding to North Carolina, or about `r SEdata$perCapita[3]` per person. North Carolina ranks 3rd for funding committed within the Southeast and 9th on a per capita basis.
<br>
``` {r echo=FALSE, fig.align='center'}
...
As of July 13, 2023, the federal government had committed `r SEdata$Funding[10]` in Infrastructure Investment and Jobs Act funding to South Carolina, or about `r SEdata$perCapita[10]` per person. South Carolina ranks 10th for funding committed within the Southeast and 10th on a per capita basis.
<br>
``` {r echo=FALSE}
...
As of July 13, 2023, the federal government had committed `r SEdata$Funding[5]` in Infrastructure Investment and Jobs Act funding to Tennessee, or about `r SEdata$perCapita[5]` per person. Tennessee ranks 5th for funding committed within the Southeast and 7th on a per capita basis.
<br>
``` {r echo=FALSE}
...
As of July 13, 2023, the federal government had committed `r SEdata$Funding[4]` in Infrastructure Investment and Jobs Act funding to Virginia, or about `r SEdata$perCapita[4]` per person. Virginia ranks 4th for funding committed within the Southeast and 8th on a per capita basis.
<br>
``` {r echo=FALSE}
